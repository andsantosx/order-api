...
export class ProductController {
  ...
  async create(req: Request, res: Response, next: NextFunction) {
    const { name, price_cents, currency, categoryId, sizeId, stock } = req.body;
    const product = await this.productService.create(name, price_cents, currency, categoryId, sizeId, stock);
